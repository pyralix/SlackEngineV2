...
def quick_working_response(
    ...
    prompt = (
        ...
        "- Assures the user the agent is now working with its team on their request,\n"
        ...
        "EXAMPLES:\n"
        "‘<@{user_id}> Got your request! Working on it now—hang tight while I work with my team.’\n"
        "‘<@{user_id}> My team is on it! We're analyzing your question and will reply soon.’\n"
        "\n"
